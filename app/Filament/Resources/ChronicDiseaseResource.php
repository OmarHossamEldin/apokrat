...
use App\Filament\Resources\ChronicDiseaseResource\RelationManagers;
use App\Filament\Resources\ChronicDiseaseResource\Pages;
...
class ChronicDiseaseResource extends Resource
{
    ...
    */
    ...
    {
        return [
            'index' => Pages\ListChronicDiseases::route('/'),
            'create' => Pages\CreateChronicDisease::route('/create'),
            // 'view' => Pages\ViewChronicDisease::route('/{record}'),
            'edit' => Pages\EditChronicDisease::route('/{record}/edit'),
        ];
    }
