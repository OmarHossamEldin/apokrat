...
use App\Filament\Resources\InjuryResource\RelationManagers;
use CactusGalaxy\FilamentAstrotomic\TranslatableTab;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Filament\Resources\InjuryResource\Pages;
...
class InjuryResource extends Resource
{
    use FilamentTranslationTrait;

    protected static ?string $model = Injury::class;
    ...
    */
    ...
    {
        return [
            'index' => Pages\ListInjuries::route('/'),
            'create' => Pages\CreateInjury::route('/create'),
            // 'view' => Pages\ViewInjury::route('/{record}'),
            'edit' => Pages\EditInjury::route('/{record}/edit'),
        ];
    }
